...
class DeplafonnementView extends GetView<DeplafonnementController> {
  const DeplafonnementView({super.key});
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                // Display name, telephone, and plafond
                Card(
                  elevation: 4,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                            'Plafond Actuel: ${controller.plafond.toStringAsFixed(2)}',
                            style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: Colors.red,
