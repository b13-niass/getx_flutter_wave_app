...
import 'package:getx_wave_app/app/modules/contactselection/controllers/contactselection_controller.dart';
...
class ContactSelectionView extends GetView<ContactSelectionController> {
  const ContactSelectionView({super.key});
