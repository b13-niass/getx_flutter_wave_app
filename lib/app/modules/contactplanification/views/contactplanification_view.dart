...
import 'package:getx_wave_app/app/modules/contactplanification/controllers/contactplanification_controller.dart';
import 'package:getx_wave_app/app/modules/contactplanification/views/widgets/tab_contact_widget.dart';
import 'package:getx_wave_app/core/theme/colors.dart';

class ContactplanificationView extends GetView<ContactplanificationController> {
  const ContactplanificationView({super.key});
          ...
          return FloatingActionButton.extended(
            onPressed: () {
              final selected = controller.contacts
                  ...
                  .toList();
              Get.toNamed('/planificationmultiple', arguments: {'contacts': selected});
            },
            backgroundColor: AppColors.primaryLight,
